...
class QLearningNeuralNetwork(Model):
    ...
    def __init__(self, inputLayer, hiddenLayerSizes, outputLayer):
        ...
        self.Q = MLPRegressor(warm_start=True, max_iter=5, verbose=1, tol=-1, solver='sgd', learning_rate_init=0.00001, learning_rate='constant', batch_size=32, hidden_layer_sizes=hiddenLayerSizes)
